...
function GetRDeeComponent() {
  return (
    <section className="getrdee">
      <div className="container get-r-dee-box">
        <div className="re-dee__container">
        ...
        <div className="description">
          <div className="description-box">
            ...
            <p>
              ...
              data network of thousands of nodes that help secure, authenticate,
              and deliver healthcare communication, productivity, and data
              quickly and easily.
            </p>
            <p>
            ...
            <p>
              ...
              health record, secured and available at their fingertips, ready to
